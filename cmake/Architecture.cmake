...
function(xsimd_get_target out_var)
    ...
    elseif(proc MATCHES "^(powerpc64|ppc64)")
        set(${out_var} "ppc64" PARENT_SCOPE)
...
# Get the flag to compile with the desired xsimd arch on loongarch64.
function(xsimd_get_loongarch64_arch_flags out_list arch loongarch64_baseline)
    if(arch STREQUAL "lsx")
        set(flags "-mlsx;-mno-lasx")
    elseif(arch STREQUAL "lasx")
        set(flags "-mlasx")
    else()
        message(FATAL_ERROR "Unknown xsimd architecture for loongarch64: ${arch}")
    endif()
    if(NOT loongarch64_baseline STREQUAL "")
...
# Get the flag to compile with the desired xsimd arch on ppc64.
function(xsimd_get_ppc64_arch_flags out_list arch ppc64_baseline)
    if(NOT arch STREQUAL "vsx")
        message(FATAL_ERROR "Unknown xsimd architecture for ppc64: ${arch}")
    endif()
    if(ppc64_baseline STREQUAL "")
        # 64-bit integer vector operations require ISA 2.07.
        set(ppc64_baseline "power8")
    endif()
    set(${out_list} "-mcpu=${ppc64_baseline};-maltivec;-mvsx" PARENT_SCOPE)
endfunction()
