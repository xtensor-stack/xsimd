...
namespace xsimd
{
    ...
    inline batch<To, A> broadcast_as(From v) noexcept
    {
     ...
     */
    template <class To, class A = default_arch, class From>
    inline batch<To, A> load_as(From const* ptr, aligned_mode) noexcept
    {
        detail::static_check_supported_config<From, A>();
    ...
    inline batch<To, A> load_as(bool const* ptr, aligned_mode) noexcept
    {
        detail::static_check_supported_config<To, A>();
        return batch<To, A>::load_aligned(ptr);
    }

    template <class To, class A = default_arch, class From>
    inline batch<To, A> load_as(std::complex<From> const* ptr, aligned_mode) noexcept
    {
        detail::static_check_supported_config<To, A>();
        return kernel::load_complex_aligned<A>(ptr, kernel::convert<To> {}, A {});
    }

#ifdef XSIMD_ENABLE_XTL_COMPLEX
    template <class To, class A = default_arch, class From, bool i3ec>
    inline batch<To, A> load_as(xtl::xcomplex<From, From, i3ec> const* ptr, aligned_mode) noexcept
    {
        detail::static_check_supported_config<To, A>();
        detail::static_check_supported_config<From, A>();
     ...
     */
    template <class To, class A = default_arch, class From>
    inline batch<To, A> load_as(From const* ptr, unaligned_mode) noexcept
    {
        detail::static_check_supported_config<To, A>();
        detail::static_check_supported_config<From, A>();
    ...
    template <class To, class A = default_arch>
    inline batch<To, A> load_as(bool const* ptr, unaligned_mode) noexcept
    {
        return batch<To, A>::load_unaligned(ptr);
    }

    template <class To, class A = default_arch, class From>
    inline batch<To, A> load_as(std::complex<From> const* ptr, unaligned_mode) noexcept
    {
        detail::static_check_supported_config<To, A>();
        detail::static_check_supported_config<From, A>();
        return kernel::load_complex_unaligned<A>(ptr, kernel::convert<To> {}, A {});
    }

#ifdef XSIMD_ENABLE_XTL_COMPLEX
    template <class To, class A = default_arch, class From, bool i3ec>
    inline batch<To, A> load_as(xtl::xcomplex<From, From, i3ec> const* ptr, unaligned_mode) noexcept
    {
        detail::static_check_supported_config<To, A>();
        detail::static_check_supported_config<From, A>();
        return load_as<To, A>(reinterpret_cast<std::complex<From> const*>(ptr), unaligned_mode());
    }
#endif
