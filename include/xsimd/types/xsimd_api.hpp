...
/**
 * @ingroup Convert bytes/shrots/words/longs array to batch<uint8_t, A>
 *
 * Perform a conversion from arrary \c y to a batch<uint8_t, A> \c x \c T
 * @param x batch.
 * @return \c  \c T
 */
template<class A>
...
>>>>>>> Add test cases and Refine the array_to_batch implementation
