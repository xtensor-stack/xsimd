...
namespace xsimd
{
    ...
    ************************************/
    ...
    XSIMD_DEFINE_LOAD_STORE(int64_t, 2, bool, arch::neon::alignment)
    XSIMD_DEFINE_LOAD_STORE(int64_t, 2, int8_t, arch::neon::alignment)
    XSIMD_DEFINE_LOAD_STORE(int64_t, 2, uint8_t, arch::neon::alignment)
    XSIMD_DEFINE_LOAD_STORE(int64_t, 2, int16_t, arch::neon::alignment)
    XSIMD_DEFINE_LOAD_STORE(int64_t, 2, uint16_t, arch::neon::alignment)
