...
namespace xsimd
{
    ...
    XSIMD_INLINE To bit_cast(From val) noexcept
    {
    ...
    namespace detail
    {
        ...
        XSIMD_INLINE const T& get_impl(const std::tuple<Types...>& t, std::is_same<T, T>, index_sequence<I, Is...>) noexcept
        {
            return std::get<I>(t);
        }

        template <class T, class U, class... Types, size_t I, size_t... Is>
        XSIMD_INLINE const T& get_impl(const std::tuple<Types...>& t, std::is_same<T, U>, index_sequence<I, Is...>) noexcept
        {
        ...
        XSIMD_INLINE const T& get(const std::tuple<Types...>& t) noexcept
        {
    ...
    namespace detail
    {
        ...
        XSIMD_INLINE constexpr std::array<T, sizeof...(Is)>
        ...
        XSIMD_INLINE constexpr std::array<T, N>
