...
namespace xsimd
{
    ...
    inline batch<uint32_t, 4>::batch(const simd_type& rhs)
        : m_value(rhs)
    {
    }

    inline batch<uint32_t, 4>& batch<uint32_t, 4>::operator=(const simd_type& rhs)
    {
        m_value = rhs;
        return *this;
    }

    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_aligned(const int8_t* src)
    {
        int8x8_t tmp = vld1_s8((const int8_t*)src);
        int16x8_t tmp2 = vmovl_s8(tmp);
        int16x4_t tmp3 = vget_low_s16(tmp2);
        m_value = vreinterpretq_u32_s32(vmovl_s16(tmp3));
        return *this;
    }

    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_unaligned(const int8_t* src)
    {
        return load_aligned(src);
    }

    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_aligned(const uint8_t* src)
    {
    ...
    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_unaligned(const uint8_t* src)
    {
        return load_aligned(src);
    }
    ...
    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_aligned(const int16_t* src)
    {
        ...
        m_value = vreinterpretq_u32_s32(vmovl_s16(tmp));
        return *this;
    }
    ...
    {
        m_value = vreinterpretq_u32_s32(vld1q_s32(src));
        return *this;
    }
    ...
    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_aligned(const int64_t* src)
    {
        m_value = uint32x4_t{
    ...
    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_unaligned(const int64_t* src)
    {
        return load_aligned(src);
    }

    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_aligned(const uint64_t* src)
    {
        m_value = uint32x4_t{
            static_cast<uint32_t>(src[0]),
            static_cast<uint32_t>(src[1]),
    ...
    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_unaligned(const uint64_t* src)
    {
        return load_aligned(src);
    }
    ...
    {
        m_value = vcvtq_u32_f32(vld1q_f32(src));
        return *this;
    }
    ...
    inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_aligned(const double* src)
    {
        ...
        m_value = vcvtq_u32_f32(vcombine_f32(tmp_l, tmp_h));
        return *this;
    #else
        m_value = uint32x4_t{
            static_cast<uint32_t>(src[0]),
    ...
    inline void batch<uint32_t, 4>::store_aligned(int8_t* dst) const
    {
        int16x4_t tmp2 = vmovn_s32(vreinterpretq_s32_u32(m_value));
        int16x8_t tmp3 = vcombine_s16(tmp2, vdup_n_s16(0));
        int8x8_t tmp4 = vmovn_s16(tmp3);
        vst1_s8((int8_t*)dst, tmp4);
    }

    inline void batch<uint32_t, 4>::store_unaligned(int8_t* dst) const
    {
        store_aligned(dst);
    }

    inline void batch<uint32_t, 4>::store_aligned(uint8_t* dst) const
    {
    ...
    inline void batch<uint32_t, 4>::store_unaligned(uint8_t* dst) const
    {
        store_aligned(dst);
    }
    ...
    {
        int16x4_t tmp = vmovn_s32(vreinterpretq_s32_u32(m_value));
    ...
    {
        uint16x4_t tmp = vmovn_u32(m_value);
    ...
    {
        vst1q_s32(dst, vreinterpretq_s32_u32(m_value));
    }
    ...
    inline void batch<uint32_t, 4>::store_aligned(int64_t* dst) const
    {
        alignas(16) uint32_t tmp[4];
        vst1q_u32(tmp, m_value);
    ...
    inline void batch<uint32_t, 4>::store_unaligned(int64_t* dst) const
    {
        store_aligned(dst);
    }

    inline void batch<uint32_t, 4>::store_aligned(uint64_t* dst) const
    {
        alignas(16) uint32_t tmp[4];
        vst1q_u32(tmp, m_value);
        dst[0] = static_cast<uint64_t>(tmp[0]);
        dst[1] = static_cast<uint64_t>(tmp[1]);
        dst[2] = static_cast<uint64_t>(tmp[2]);
        dst[3] = static_cast<uint64_t>(tmp[3]);
    }

    inline void batch<uint32_t, 4>::store_unaligned(uint64_t* dst) const
    {
        store_aligned(dst);
    }
    ...
    {
        vst1q_f32(dst, vcvtq_f32_u32(m_value));
    }
    ...
    inline batch<uint32_t, 4>::operator simd_type() const
    {
        return m_value;
    }
