...
namespace xsimd
{
    ...
    {
        return bool_proxy<uint16_t>(m_array[index]);
    }
    ...
    {
        return bool_proxy<uint32_t>(m_array[index]);
    }
    ...
    {
        return bool_proxy<uint8_t>(m_array[index]);
    }
    ...
    {
        return bool_proxy<uint64_t>(m_array[index]);
    }
