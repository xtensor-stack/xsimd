...
namespace xsimd
{
    ...
    namespace kernel
    {
        ...
        XSIMD_INLINE typename batch<T, A>::value_type hadd(batch<T, A> const& arg, requires_arch<neon64>) noexcept
        {
        ...
        template <class A>
        XSIMD_INLINE double hadd(batch<double, A> const& arg, requires_arch<neon64>) noexcept
        {
        ...
        XSIMD_INLINE batch<double, A> select(batch_bool_constant<batch<double, A>, b...> const&,
...
#define WRAP_CAST(SUFFIX, TYPE)                                                                                              \
    namespace wrap                                                                                                           \
    {                                                                                                                        \
        XSIMD_INLINE float64x2_t vreinterpretq_f64_##SUFFIX(TYPE a) noexcept { return ::vreinterpretq_f64_##SUFFIX(a); }     \
        XSIMD_INLINE TYPE vreinterpretq_##SUFFIX##_f64(float64x2_t a) noexcept { return ::vreinterpretq_##SUFFIX##_f64(a); } \
    }
...
#undef WRAP_CAST
        ...
        template <class A>
        XSIMD_INLINE batch_bool<double, A> bool_cast(batch_bool<int64_t, A> const& arg, requires_arch<neon64>) noexcept
        {
        ...
        template <class A>
        XSIMD_INLINE batch_bool<int64_t, A> bool_cast(batch_bool<double, A> const& arg, requires_arch<neon64>) noexcept
        {
            using register_type = typename batch_bool<double, A>::register_type;
            return register_type(arg);
        }
        ...
        template <class A>
        XSIMD_INLINE batch<int64_t, A> to_int(const batch<double, A>& x, requires_arch<neon64>) noexcept
        {
        ...
        template <class A>
        XSIMD_INLINE batch<double, A> to_float(batch<int64_t, A> const& x, requires_arch<neon64>) noexcept
        {
