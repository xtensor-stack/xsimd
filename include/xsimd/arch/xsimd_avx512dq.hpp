...
namespace xsimd
{
    ...
    namespace kernel
    {
        ...
        // to_float
        template <class A>
        XSIMD_INLINE batch<double, A> to_float(batch<int64_t, A> const& self, requires_arch<avx512dq>) noexcept
        {
        ...
        // to_int
        template <class A>
        XSIMD_INLINE batch<int64_t, A> to_int(batch<double, A> const& self, requires_arch<avx512dq>) noexcept
        {
