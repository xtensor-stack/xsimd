...
namespace xsimd
{
    ...
    namespace kernel
    {
        ...
        // bool_cast
        template <class A>
        XSIMD_INLINE batch_bool<int32_t, A> bool_cast(batch_bool<float, A> const& self, requires_arch<avx512f>) noexcept
        {
            return self.data;
        }
        template <class A>
        XSIMD_INLINE batch_bool<float, A> bool_cast(batch_bool<int32_t, A> const& self, requires_arch<avx512f>) noexcept
        {
            return self.data;
        }
        template <class A>
        XSIMD_INLINE batch_bool<int64_t, A> bool_cast(batch_bool<double, A> const& self, requires_arch<avx512f>) noexcept
        {
            return self.data;
        }
        template <class A>
        XSIMD_INLINE batch_bool<double, A> bool_cast(batch_bool<int64_t, A> const& self, requires_arch<avx512f>) noexcept
        {
            return self.data;
        }
        ...
        // hadd
        template <class A>
        XSIMD_INLINE float hadd(batch<float, A> const& rhs, requires_arch<avx512f>) noexcept
        {
        ...
        template <class A>
        XSIMD_INLINE double hadd(batch<double, A> const& rhs, requires_arch<avx512f>) noexcept
        {
        ...
        template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
        XSIMD_INLINE T hadd(batch<T, A> const& self, requires_arch<avx512f>) noexcept
        {
            __m256i low, high;
...
#undef step1
        ...
        // sadd
        template <class A>
        XSIMD_INLINE batch<float, A> sadd(batch<float, A> const& self, batch<float, A> const& other, requires_arch<avx512f>) noexcept
        {
            return add(self, other); // no saturated arithmetic on floating point numbers
        }
        template <class A>
        XSIMD_INLINE batch<double, A> sadd(batch<double, A> const& self, batch<double, A> const& other, requires_arch<avx512f>) noexcept
        {
            return add(self, other); // no saturated arithmetic on floating point numbers
        }
        template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
        ...
        XSIMD_INLINE batch<T, A> select(batch_bool_constant<batch<T, A>, Values...> const&, batch<T, A> const& true_br, batch<T, A> const& false_br, requires_arch<avx512f>) noexcept
        {
        ...
        // ssub
        template <class A>
        XSIMD_INLINE batch<float, A> ssub(batch<float, A> const& self, batch<float, A> const& other, requires_arch<avx512f>) noexcept
        {
            return _mm512_sub_ps(self, other); // no saturated arithmetic on floating point numbers
        }
        template <class A>
        XSIMD_INLINE batch<double, A> ssub(batch<double, A> const& self, batch<double, A> const& other, requires_arch<avx512f>) noexcept
        {
        ...
        // to_float
        template <class A>
        XSIMD_INLINE batch<float, A> to_float(batch<int32_t, A> const& self, requires_arch<avx512f>) noexcept
        {
            return _mm512_cvtepi32_ps(self);
        }
        template <class A>
        XSIMD_INLINE batch<double, A> to_float(batch<int64_t, A> const& self, requires_arch<avx512f>) noexcept
        {
        ...
        // to_int
        template <class A>
        XSIMD_INLINE batch<int32_t, A> to_int(batch<float, A> const& self, requires_arch<avx512f>) noexcept
        {
            return _mm512_cvttps_epi32(self);
        }

        template <class A>
        XSIMD_INLINE batch<int64_t, A> to_int(batch<double, A> const& self, requires_arch<avx512f>) noexcept
        {
        ...
        // zip_hi
        template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
        XSIMD_INLINE batch<T, A> zip_hi(batch<T, A> const& self, batch<T, A> const& other, requires_arch<avx512f>) noexcept
        {
            switch (sizeof(T))
            {
            case 1:
        ...
        template <class A>
        XSIMD_INLINE batch<float, A> zip_hi(batch<float, A> const& self, batch<float, A> const& other, requires_arch<avx512f>) noexcept
        {
            return _mm512_unpackhi_ps(self, other);
        }
        template <class A>
        XSIMD_INLINE batch<double, A> zip_hi(batch<double, A> const& self, batch<double, A> const& other, requires_arch<avx512f>) noexcept
        {
        ...
        // zip_lo
        template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
        XSIMD_INLINE batch<T, A> zip_lo(batch<T, A> const& self, batch<T, A> const& other, requires_arch<avx512f>) noexcept
        {
            switch (sizeof(T))
            {
            case 1:
        ...
        template <class A>
        XSIMD_INLINE batch<float, A> zip_lo(batch<float, A> const& self, batch<float, A> const& other, requires_arch<avx512f>) noexcept
        {
            return _mm512_unpacklo_ps(self, other);
        }
        template <class A>
        XSIMD_INLINE batch<double, A> zip_lo(batch<double, A> const& self, batch<double, A> const& other, requires_arch<avx512f>) noexcept
        {
