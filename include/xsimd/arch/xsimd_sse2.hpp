...
namespace xsimd
{
    ...
    namespace kernel
    {
        ...
        // bool_cast
        template <class A>
        batch_bool<int32_t, A> XSIMD_INLINE bool_cast(batch_bool<float, A> const& self, requires_arch<sse2>) noexcept
        {
            return _mm_castps_si128(self);
        }
        template <class A>
        batch_bool<float, A> XSIMD_INLINE bool_cast(batch_bool<int32_t, A> const& self, requires_arch<sse2>) noexcept
        {
            return _mm_castsi128_ps(self);
        }
        template <class A>
        batch_bool<int64_t, A> XSIMD_INLINE bool_cast(batch_bool<double, A> const& self, requires_arch<sse2>) noexcept
        {
            return _mm_castpd_si128(self);
        }
        template <class A>
        batch_bool<double, A> XSIMD_INLINE bool_cast(batch_bool<int64_t, A> const& self, requires_arch<sse2>) noexcept
        {
            return _mm_castsi128_pd(self);
        }
        ...
        namespace detail
        {
            ...
            template <class A>
            XSIMD_INLINE batch<float, A> fast_cast(batch<uint32_t, A> const& v, batch<float, A> const&, requires_arch<sse2>) noexcept
            {
        ...
        // hadd
        template <class A>
        XSIMD_INLINE float hadd(batch<float, A> const& self, requires_arch<sse2>) noexcept
        {
        ...
        {
            template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
            XSIMD_INLINE T hadd_default(batch<T, A> const& self, requires_arch<sse2>) noexcept
            {
        ...
        template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
        XSIMD_INLINE T hadd(batch<T, A> const& self, requires_arch<sse2>) noexcept
        {
            switch (sizeof(T))
            {
            case 4:
        ...
        template <class A>
        XSIMD_INLINE double hadd(batch<double, A> const& self, requires_arch<sse2>) noexcept
        {
        ...
        XSIMD_INLINE batch<T, A> select(batch_bool_constant<batch<T, A>, Values...> const&, batch<T, A> const& true_br, batch<T, A> const& false_br, requires_arch<sse2>) noexcept
        {
        ...
        // sadd
        template <class A>
        XSIMD_INLINE batch<float, A> sadd(batch<float, A> const& self, batch<float, A> const& other, requires_arch<sse2>) noexcept
        {
        ...
        {
            template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
            XSIMD_INLINE batch<T, A> sadd_default(batch<T, A> const& self, batch<T, A> const& other, requires_arch<sse2>) noexcept
            {
                if (std::is_signed<T>::value)
                {
        ...
        template <class A>
        XSIMD_INLINE batch<double, A> sadd(batch<double, A> const& self, batch<double, A> const& other, requires_arch<sse2>) noexcept
        {
        ...
        // ssub
        template <class A>
        XSIMD_INLINE batch<float, A> ssub(batch<float, A> const& self, batch<float, A> const& other, requires_arch<sse2>) noexcept
        {
        ...
        {
            template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
            XSIMD_INLINE batch<T, A> ssub_default(batch<T, A> const& self, batch<T, A> const& other, requires_arch<sse2>) noexcept
            {
                if (std::is_signed<T>::value)
                {
        ...
        template <class A>
        XSIMD_INLINE batch<double, A> ssub(batch<double, A> const& self, batch<double, A> const& other, requires_arch<sse2>) noexcept
        {
        ...
        // to_float
        template <class A>
        XSIMD_INLINE batch<float, A> to_float(batch<int32_t, A> const& self, requires_arch<sse2>) noexcept
        {
            return _mm_cvtepi32_ps(self);
        }
        template <class A>
        XSIMD_INLINE batch<double, A> to_float(batch<int64_t, A> const& self, requires_arch<sse2>) noexcept
        {
        ...
        // to_int
        template <class A>
        XSIMD_INLINE batch<int32_t, A> to_int(batch<float, A> const& self, requires_arch<sse2>) noexcept
        {
            return _mm_cvttps_epi32(self);
        }

        template <class A>
        XSIMD_INLINE batch<int64_t, A> to_int(batch<double, A> const& self, requires_arch<sse2>) noexcept
        {
