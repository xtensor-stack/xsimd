...
namespace xsimd
{
    ...
    namespace kernel
    {
        ...
        template <class A>
        batch<double, A> inline bitwise_and(batch<double, A> const& self, batch<double, A> const& other, requires_arch<sse2>)
        {
        ...
        // bool_cast
        template <class A>
        batch_bool<int32_t, A> inline bool_cast(batch_bool<float, A> const& self, requires_arch<sse2>)
        {
            return _mm_castps_si128(self);
        }
        template <class A>
        batch_bool<float, A> inline bool_cast(batch_bool<int32_t, A> const& self, requires_arch<sse2>)
        {
            return _mm_castsi128_ps(self);
        }
        template <class A>
        batch_bool<int64_t, A> inline bool_cast(batch_bool<double, A> const& self, requires_arch<sse2>)
        {
            return _mm_castpd_si128(self);
        }
        template <class A>
        batch_bool<double, A> inline bool_cast(batch_bool<int64_t, A> const& self, requires_arch<sse2>)
        {
            return _mm_castsi128_pd(self);
        }
        ...
        // broadcast
        template <class A>
        batch<float, A> inline broadcast(float val, requires_arch<sse2>)
        {
    ...
    // array to batch
    template<class A>
    batch<uint8_t, A> bytes_array_to_batch(batch<uint8_t, A>&, std::array<int8_t, batch<int8_t>::size>& bytes_array, requires_arch<sse2>) {
      return _mm_set_epi8(
    ...
    template<class A>
    batch<uint8_t, A> shorts_array_to_batch(batch<uint8_t, A>&, std::array<int16_t, batch<int16_t>::size>& shorts_array, requires_arch<sse2>) {
    ...
    template<class A>
    batch<uint8_t, A> words_array_to_batch(batch<uint8_t, A>&, std::array<int32_t, batch<int32_t>::size>& words_array, requires_arch<sse2>) {
      return _mm_set_epi32(words_array[3], words_array[2], words_array[1], words_array[0]);
    }

    template<class A>
    batch<uint8_t, A> longs_array_to_batch(batch<uint8_t, A>&, std::array<int64_t, batch<int64_t>::size>& longs_array, requires_arch<sse2>) {
