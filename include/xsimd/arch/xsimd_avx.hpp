...
namespace xsimd
{
    ...
    namespace kernel
    {
        ...
        // bool_cast
        template <class A>
        XSIMD_INLINE batch_bool<int32_t, A> bool_cast(batch_bool<float, A> const& self, requires_arch<avx>) noexcept
        {
            return _mm256_castps_si256(self);
        }
        template <class A>
        XSIMD_INLINE batch_bool<float, A> bool_cast(batch_bool<int32_t, A> const& self, requires_arch<avx>) noexcept
        {
            return _mm256_castsi256_ps(self);
        }
        template <class A>
        XSIMD_INLINE batch_bool<int64_t, A> bool_cast(batch_bool<double, A> const& self, requires_arch<avx>) noexcept
        {
            return _mm256_castpd_si256(self);
        }
        template <class A>
        XSIMD_INLINE batch_bool<double, A> bool_cast(batch_bool<int64_t, A> const& self, requires_arch<avx>) noexcept
        {
            return _mm256_castsi256_pd(self);
        }
        ...
        namespace detail
        {
            ...
            template <class A>
            XSIMD_INLINE batch<float, A> fast_cast(batch<uint32_t, A> const& v, batch<float, A> const&, requires_arch<avx>) noexcept
            {
        ...
        // hadd
        template <class A>
        XSIMD_INLINE float hadd(batch<float, A> const& rhs, requires_arch<avx>) noexcept
        {
        ...
        template <class A>
        XSIMD_INLINE double hadd(batch<double, A> const& rhs, requires_arch<avx>) noexcept
        {
            // rhs = (x0, x1, x2, x3)
            // tmp = (x2, x3, x0, x1)
        ...
        template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
        XSIMD_INLINE T hadd(batch<T, A> const& self, requires_arch<avx>) noexcept
        {
            __m128i low, high;
        ...
        // sadd
        template <class A>
        XSIMD_INLINE batch<float, A> sadd(batch<float, A> const& self, batch<float, A> const& other, requires_arch<avx>) noexcept
        {
            return add(self, other); // no saturated arithmetic on floating point numbers
        }
        template <class A>
        XSIMD_INLINE batch<double, A> sadd(batch<double, A> const& self, batch<double, A> const& other, requires_arch<avx>) noexcept
        {
            return add(self, other); // no saturated arithmetic on floating point numbers
        }
        template <class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
        ...
        XSIMD_INLINE batch<T, A> select(batch_bool_constant<batch<T, A>, Values...> const&, batch<T, A> const& true_br, batch<T, A> const& false_br, requires_arch<avx>) noexcept
        {
        ...
        // ssub
        template <class A>
        XSIMD_INLINE batch<float, A> ssub(batch<float, A> const& self, batch<float, A> const& other, requires_arch<avx>) noexcept
        {
            return _mm256_sub_ps(self, other); // no saturated arithmetic on floating point numbers
        }
        template <class A>
        XSIMD_INLINE batch<double, A> ssub(batch<double, A> const& self, batch<double, A> const& other, requires_arch<avx>) noexcept
        {
        ...
        // to_float
        template <class A>
        XSIMD_INLINE batch<float, A> to_float(batch<int32_t, A> const& self, requires_arch<avx>) noexcept
        {
            return _mm256_cvtepi32_ps(self);
        }
        template <class A>
        XSIMD_INLINE batch<double, A> to_float(batch<int64_t, A> const& self, requires_arch<avx>) noexcept
        {
        ...
        // to_int
        template <class A>
        XSIMD_INLINE batch<int32_t, A> to_int(batch<float, A> const& self, requires_arch<avx>) noexcept
        {
            return _mm256_cvttps_epi32(self);
        }

        template <class A>
        XSIMD_INLINE batch<int64_t, A> to_int(batch<double, A> const& self, requires_arch<avx>) noexcept
        {
