...
namespace xsimd
{
    ...
    namespace kernel
    {
        ...
        // hadd
        template <class A>
        XSIMD_INLINE float hadd(batch<float, A> const& self, requires_arch<sse3>) noexcept
        {
        ...
        template <class A>
        XSIMD_INLINE double hadd(batch<double, A> const& self, requires_arch<sse3>) noexcept
        {
